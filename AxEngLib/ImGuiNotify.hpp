...
public:
     ...
     */
    inline void setType(const ImGuiToastType& t)
    {
        IM_ASSERT(t < ImGuiToastType::COUNT);
        this->type = t;
    };
    ...
    */
    inline void setWindowFlags(const ImGuiWindowFlags& f)
    {
        this->flags = f;
    }
    ...
    */
    inline void setOnButtonPress(const std::function<void()>& obp)
    {
        this->onButtonPress = obp;
    }
